...
export default function App() {
  ...
  // --- BUSCA DE DADOS (CORRIGIDA: Adicionado student_id para evitar repetições) ---
  ...
  // --- FUNÇÃO DE SAÍDA CORRIGIDA (Salva no histórico e atualiza status) ---
  const handleRegisterExit = async () => {
    ...
    const logDesc = JSON.stringify({
      ...
      motivos: [exitType], // Vai salvar "TRANSFERIDO" ou "ABANDONO"
