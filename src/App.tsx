...
export default function App() {
  ...
  // CORREÇÃO AQUI: Limpa o formulário ao trocar de aluno
  useEffect(() => {
    setObsLivre("");
    ...
    setEncaminhamento('');
    setExitReason(''); // <-- Limpa o motivo da saída também
  }, [selectedStudent]);
  ...
  const handleRegisterExit = async () => {
    ...
    if (!error) {
      ...
      setExitReason(''); // CORREÇÃO AQUI: Limpa o campo após sucesso
