  ...
  {['perfil', 'academico', 'historico', 'familia'].map((tab) => {
    ...
    return (
      <button
        ...
        className={`py-5 font-bold text-sm border-b-4 uppercase tracking-wide transition-colors ${
          activeTab === tab
